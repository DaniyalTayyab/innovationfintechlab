                    ...
                    <swiper-slide class="sx-bnr-2-wrap swiper-slide overlay-overlay" style={{ backgroundImage: `url(${publicUrlFor("images/main-slider/slider2/slide1.jpg")})` }}>
                        ...
                        <div className="container">
                            <div className="sx-bnr-2-content">
                                ...
                                <h2 className="sx-bnr-2-large-title">Best IT Services provider Our Companey In Our Country.</h2>
                                <div className="sx-bnr-2-info">Empowering your business with cutting-edge IT services and unparalleled support.</div>
                    ...
                    <swiper-slide class="sx-bnr-2-wrap swiper-slide overlay-overlay" style={{ backgroundImage: `url(${publicUrlFor("images/main-slider/slider2/slide1.jpg")})` }}>
                        ...
                        <div className="container">
                            <div className="sx-bnr-2-content">
                                ...
                                <div className="sx-bnr-2-info">Innovative technologies tailored to meet your unique business needs.</div>
                                <div className="sx-bnr-readmore">
