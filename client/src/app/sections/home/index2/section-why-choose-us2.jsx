            ...
            <div className="row">
                ...
                <div className="col-lg-6 col-md-12">
                    <div className="sx-about-bx4-content">
                        ...
                        <p>Experience excellence and innovation with our team. We prioritize quality, commitment, and client satisfaction, ensuring exceptional results tailored to your needs.</p>
